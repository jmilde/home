...
#+BEGIN_SRC emacs-lisp
  ...
  ; add an UID when creating any capture
  (add-hook 'org-capture-prepare-finalize-hook 'org-id-get-create)

  ;key bindings
  (global-set-key (kbd "C-c o")
                (lambda () (interactive) (find-file "~/shared/org/orgfiles/life.org")))
  ...
  (setq org-capture-templates
    '(
    ("t" "TODO" entry (file "~/shared/org/orgfiles/inbox.org") (file "~/shared/org/templates/tpl_todo.txt") :empty-lines-after 1)
    ("d" "daily" entry (file+olp+datetree "~/shared/org/orgfiles/life.org" "daily") (file "~/shared/org/templates/tpl_daily.txt")  :empty-lines-after 1)
    ("p" "Private Templates")
      ("pb" "Book-list" entry (file+headline "~/shared/org/orgfiles/life.org" "book list") (file "~/shared/org/templates/tpl_books.txt") :empty-lines-after 1)
      ("pj" "Journal" entry (file+datetree "~/shared/org/orgfiles/journal.org") "** %T - %^{Heading}")
      ("pr" "Weekly Review" entry (file+datetree "~/shared/org/orgfiles/weekly_review.org") (file "~/shared/org/templates/tpl_weekly_review.txt"))
   ("s" "Shopping" entry (file "~/shared/org/orgfiles/backlog.org") (file "~/shared/org/templates/tpl_shopping.txt") :empty-lines 1)
   ("w"  "work")
   ("wi" "interview" entry(file+headline "~/shared/org/orgfiles/interviews.org" "doctors") (file "~/shared/org/templates/tpl_interview.txt") :emtpy-lines-after 1)

  ))

  (setq org-agenda-files (list
  "~/shared/org/orgfiles/backlog.org"
  "~/shared/org/orgfiles/life.org"
  "~/shared/org/orgfiles/journal.org"))
